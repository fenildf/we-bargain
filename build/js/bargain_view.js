  ...
  render: function() {
    ...
    if(_data.type != 1){
      ...
      if(_data.hasOwnProperty('bargainEndTime')){
        ...
        _assistBtn = (React.createElement("a", {href: "#/assist", className: "am-btn am-btn-warning am-disabled am-btn-lg am-fl am-margin-left-sm am-round course_btn"}, "帮TA砍价"));
      }
      ...
      btn = (
        React.createElement("div", {className: ""}, 
          _assistBtn, 
          React.createElement("a", {href: "/Welfares/", className: "am-btn am-btn-primary am-btn-lg am-fr am-round course_btn am-margin-right-sm"}, "我也要参加")
        )
      );
      shareBtn = (
      ...
      if(_data.hasOwnProperty('bargainEndTime')){
        ...
        btn = (
          React.createElement("div", {className: ""}, 
          React.createElement("a", {href: "/ShoppingCart/addCart/"+ this.props.cid + "-0-0-0", className: "am-btn am-btn-danger am-btn-lg am-center am-round am-fl am-margin-left-sm course_btn"}, "立即购买"), 
            /*<UI.Button amSize="lg" amStyle="danger" round className="course_btn am-fl am-margin-left-sm">立即购买</UI.Button>*/
            React.createElement(UI.Button, {amSize: "lg", onClick: this.handleShare, amStyle: "primary", round: true, className: "course_btn am-fr am-margin-right-sm"}, "分享给朋友帮砍价")
          )
        );
