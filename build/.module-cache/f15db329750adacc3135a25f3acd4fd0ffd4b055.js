  ...
  render: function() {
    var listNode = this.props.data.map(function(con){
      ...
      return (
        ...
        React.createElement("div", {className: "am-list-thumb am-u-sm-3 am-text-center am-padding-xs"}, 
            React.createElement(UI.Image, {src: con.teacherImg, width: "60", height: "60", responsive: true, className: "am-center am-img-thumbnail am-radius"}), 
            React.createElement("p", {className: "am-center am-margin-xs"}, con.teacherName)
        ), 
        React.createElement("div", {className: "am-list-main am-u-sm-9"}, 
          React.createElement("h4", {className: "am-list-item am-margin-bottom-0"}, con.courseName), 
